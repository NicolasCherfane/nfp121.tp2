...
public class FahrenheitCelsiusTest extends junit.framework.TestCase
{
     ...
     */
      public void test_test1(){
        assertTrue(question1.FahrenheitCelsius.fahrenheitEnCelsius(55) == (float)12.7);
    }
    
    public void test_test2(){
        assertTrue(question1.FahrenheitCelsius.fahrenheitEnCelsius(3) == (float)-16.1);
    }
    
    public void test_test3(){
        assertTrue(question1.FahrenheitCelsius.fahrenheitEnCelsius(1000) == (float)537.7);
